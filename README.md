...
where *needs_train* means a model with parameters is learned on top of the sentence embeddings, and *set_classifier* means it is possible to define the parameters of the classifier on this task (see below).
